...
def start_timer():
    ...
    if reps == 8:
        ...
        work_sessions += 1
        checkmarks.config(text=("✔"*work_sessions))
...
#Num of pomodoros completed
checkmarks = Label(text="✔️", fg=GREEN, bg=YELLOW, font=(FONT_NAME, 35))
